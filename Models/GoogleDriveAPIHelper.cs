...
namespace GoogleDriveUploadMVC.Models
{
    public class GoogleDriveAPIHelper
    {
        ...
        public static DriveService GetService()
        {
            ...
            using (var stream = new FileStream(Path.Combine(CSPath, "client_secret_7897285680-suqiqunnq8b7sj4ii6gv63i4tc3molll.apps.googleusercontent.com.json"), FileMode.Open, FileAccess.Read))
            {
